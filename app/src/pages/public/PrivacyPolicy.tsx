  ...
  return (
    <LegalPageLayout title="Privacy Policy — UNSW PakSoc Manager" effectiveDate="July 10, 2026">
      ...
      <LegalSection title="4. Third-Party Services">
        <LegalParagraph>
          We use Google for authentication, Supabase for backend services, and AWS for image storage.
        </LegalParagraph>
      </LegalSection>
      ...
      <LegalSection title="5. Contact">
        <LegalParagraph>
          ...
          <a href="mailto:syedayanata@gmail.com" className="text-green-700 font-medium hover:underline">
            syedayanata@gmail.com
          </a>.
        </LegalParagraph>
      </LegalSection>
    </LegalPageLayout>
